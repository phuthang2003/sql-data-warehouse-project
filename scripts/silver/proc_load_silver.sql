...
==================================================
Purpose
  This stored procudure performs the ETL (Extract, Transform, Load) process to populate the 'silver' schema tables from the 'bronze' schema.
  It performs the following actions:
    - Truncate the silver tables before loading data.
    - Insert transformed and clean data into silver tables.
*/
